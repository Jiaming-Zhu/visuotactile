...
from train_fusion import FusionModel, RoboticGraspDataset, resolve_device, set_seed
...
def run(args: argparse.Namespace) -> None:
    ...
    if args.output_dir:
        ...
        output_dir = checkpoint.parent / "attention_maps"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Visualize attention maps for FusionModel (train_fusion.py) on test and ood_test splits."
    )
