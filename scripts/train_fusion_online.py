...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fusion training with prefix-aware online masking")
    ...
    parser.add_argument("--save_dir", type=str, default="outputs/fusion_model_online")
